...
<div class="row">
	<div class="col s12">
		<div class="input-field col s12">
			<?php echo form_dropdown('inputParent', $dataParent, $valueParent, "id='inputParent' ".$disabledParent); ?>
			<label for="inputParent">หน่วยงาน</label>
		</div>
		<div class="input-field col s12">
...
<div class="section">
    <div class="row">
        ...
        <div class="col s2 offset-s6 m2 offset-m8 right-align"> 
            <a href="<?php echo site_url('admin/Company/department') ?>" class="btn red lighten-1 right-align">ยกเลิก</a>
        </div>
    </div>
</div>
<?php echo form_close(); ?>
<script type="text/javascript">
	...
	{
		$("select").removeAttr("disabled").click();
		return true;
	}
</script>