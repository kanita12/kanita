...
<?php echo form_open() ?>
<input type="hidden" id="hd_leavegroup_id" name="hd_leavegroup_id" value="<?php echo $value_leavegroup_id; ?>">
<div class="row">
	<div class="col s12">
		<div class="input-field col s12">
			<input type="text" id="input_name" name="input_name" value="<?php echo $value_name; ?>">
			<label for="input_name">ชื่อกรุ๊ปลา</label>
		</div>
		<div class="input-field col s12">
...
<div class="section">
	<div class="row">
		...
		<div class="col s4 offset-s4 right-align">
			<a href="<?php echo site_url("admin/Leavegroup") ?>" class="btn waves-effect waves-light red">ยกเลิก</a>
		</div>
	</div>
</div>
<?php echo form_close(); ?>
