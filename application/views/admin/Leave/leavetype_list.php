<div class="row">
	...
	<div class="col s2">
		<div class="row right-align">
			<a href="<?php echo site_url("admin/Leavetype/add"); ?>" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">add</i></a>
		</div>
	</div>
</div>
	...
	<tbody>
		<?php foreach ($query->result_array() as $row): ?>
			<tr>
				...
				<td><?php echo $row["LTDesc"] ?></td>
				<td>
					<a href="<?php echo site_url('admin/Leavetype/edit/'.$row["LTID"]) ?>" 
						class="btn-floating btn-small waves-effect waves-light blue">
						<i class="material-icons">edit</i>
					</a>
					<a href="javascript:void(0);"
						data-id="<?php echo $row["LTID"] ?>" 
						class="btn-floating btn-small waves-effect waves-light red"
						onclick="deleteThis(this,'Leavetype/delete','<?php echo $row['LTID'] ?>');">
