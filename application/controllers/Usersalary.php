...
class Usersalary extends CI_Controller
{
	...
	public function search($year = 0, $month = 0)
	{
		...
		//get data
		$query = $this->salarypay->get_list($this->pagination->per_page, $page,$this->user_id,$year,$month);
		$query_now_salary = $this->salarypay->get_now_year_month_log($this->user_id);
