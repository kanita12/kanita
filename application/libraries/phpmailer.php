...
class PHPMailer {
  ...
  public $set_name = 'No reply HR System';
   ...
   * @var string
   */
  public $FromName          = 'No reply HR System';
  ...
  */
   ...
   * @var string
   */
  public $Username      = 'kane@catyard.net';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'kk121031';
 ...
 /**
  ...
  public function AddReplyTo($address= '', $name = '') {
    if($address == '')$address = $set_address;
    if($name == '')$name = $set_name;
